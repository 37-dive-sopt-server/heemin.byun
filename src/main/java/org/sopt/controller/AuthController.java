...
public class AuthController {
    ...
    public ResponseEntity<ApiResponseDto<MemberResponse>> login(
    ...
    public ResponseEntity<ApiResponseDto<MemberResponse>> loginV2(
    ...
    @GetMapping("/v2/me")
    public ResponseEntity<ApiResponseDto<MemberResponse>> checkSession(
    ...
    public ResponseEntity<ApiResponseDto<MemberResponse>> loginV3(
            @RequestParam("email") String email,
            @RequestParam("password") String password,
            HttpSession session
    ) {
    ...
    @GetMapping("/v3/me")
    public ResponseEntity<ApiResponseDto<MemberResponse>> checkSessionV3(
            HttpSession session
    ) {
    ...
    public ResponseEntity<ApiResponseDto<String>> loginV4(
            @RequestParam("email") String email,
            @RequestParam("password") String password
    ) {
        ...
        return ResponseEntity.ok(ApiResponseDto.success(token));
    }

    @Operation(summary = "JWT 검증 (Authorization: Bearer)")
    @GetMapping("/v4/me")
    public ResponseEntity<ApiResponseDto<MemberResponse>> checkSessionV4(
            @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization
    ) {
        String raw = null;
